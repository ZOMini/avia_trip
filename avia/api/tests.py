...
class Test_API(APITestCase):
    ...
    def test_trip(self):
        ...
        self.client.post('/api/v1/airport/', {"name": "Пулково-1(Санкт-Петербург)"}, format='json')
        self.client.post('/api/v1/airport/', {'name': "Шереметьево(Москва)"}, format='json')
        response = self.client.post('/api/v1/trip/', {"time_out": "2023-07-23T05:30:00Z","time_in": "2023-07-23T06:00:00Z","company": 6,"plane": 6,"airport_from": 7,"airport_to": 8}, format='json')
        self.assertEqual(response.status_code, 201)
        self.assertEqual(response.json(), {"id": 2,"time_out": "2023-07-23T05:30:00Z","time_in": "2023-07-23T06:00:00Z","company": 6,"plane": 6,"airport_from": 7,"airport_to": 8})
        # ----get request----
        ...
        # ----update request----
        response = self.client.put('/api/v1/trip/2/', {"time_out": "2023-07-23T07:30:00Z","time_in": "2023-07-23T08:00:00Z","company": 6,"plane": 6,"airport_from": 7,"airport_to": 8}, format='json')
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json(), {"id":2,"time_out": "2023-07-23T07:30:00Z","time_in": "2023-07-23T08:00:00Z","company": 6,"plane": 6,"airport_from": 7,"airport_to": 8})
        # ----delete request----
    ...
    def test_pass_in_trip(self):
        ...
        self.client.post('/api/v1/airport/', {"name": "Пулково-1(Санкт-Петербург)"}, format='json')
        self.client.post('/api/v1/airport/', {'name': "Шереметьево(Москва)"}, format='json')
        self.client.post('/api/v1/trip/', {"time_out": "2023-07-23T05:30:00Z","time_in": "2023-07-23T06:00:00Z","company": 5,"plane": 3,"airport_from": 5,"airport_to": 6}, format='json')
